...
if let day = dictionary["January"] {
    print("January has \(day) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
let shapesArray = ["Rectangle", "Trapezium", "Parallelogram"]
let colorsArray = ["Black", "Yellow", "Green"]


var Dictionarys = ["Shapes": shapesArray, "Colors": colorsArray]
print(Dictionarys)
...
print(colorsArray)
if let element = Dictionarys["Colors"]?.last {
    print(element)
}
