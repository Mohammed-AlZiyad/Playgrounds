...
struct User {
    ...
    static var currentUser = User(userName: "mohammed", email: "m.alziyad911@icloud.com", age: 20)
 ...
 */
User.logIn(user: User(userName: "Mohammed", email: "m.alziyad911@icloud.com", age: 20) )
